...
const CreateRoles = () =>{
  ...
  return (
    <div className="row-10 ">
      <h4 className="container col-8 my-1 mt-1"><strong>Create a new lesson</strong></h4>
      <form class=" container col-10 mt-1" method="POST" action="http://localhost:3000/api/CreateClass">
        ...
        <div className="container col-5 mt-2 m-auto">
          <button type="submit" value="Submit" class="btn btn-danger col-8 mt-2 ">Create Lesson</button>
        </div>
      </form>
